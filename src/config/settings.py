...
SECRET_KEY = "django-insecure-qw1tz*uip_c^l(0v!(gf2ug1!7x1cy0_hv)lh4jpd@$=zbzo&6"
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {
            "init_command": "PRAGMA journal_mode=wal; PRAGMA busy_timeout=10000; PRAGMA synchronous=NORMAL; PRAGMA temp_store=MEMORY;"
        },
    }
}
