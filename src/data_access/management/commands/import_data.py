    ...
    with open(file_path, newline="", encoding="utf-8") as csvfile:
        ...
        for row in reader:
            ...
            if title in title_to_id_map:
                existing_id = title_to_id_map[title]
                book_id = existing_id
                ...
                books[book_id] = Book(
                    ...
                    if row.get("ratingsCount") not in [None, "", "null"]
                    else None,
                )
                # Record this title to avoid duplicates
            ...
            reviews.append(
                Review(
                    ...
                    if row.get("review/score") not in [None, "", "null"]
                    else None,
                )
            )
...
def bulk_insert(books_dict, reviews_list):
    ...
    with transaction.atomic():
        ...
        # Use bulk_create with ignore_conflicts in case a Book with the same ID already exists
